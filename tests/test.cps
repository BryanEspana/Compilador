...
// --- Error: Método no existe en clase ---
log = log + juan.saludo() + "\n";

// --- Error: Atributo no existe en clase ---
let nombreJuan: string = juan.apellido;

// --- Error: Parámetros para instanciar clase no coinciden ---
let maria: Estudiante = new Estudiante(10, 10, 10, 10, "Hola");

// --- Error: Atributos de clase con tipos incorrectos ---
let nombreMaria: string = maria.nombre;
let edadMaria: integer = maria.edad;
