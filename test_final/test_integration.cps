// Test de integración completo - Combina todas las funcionalidades
...
// Expresión aritmética (entera) - Corregido: usar una variable definida
let edad_test: integer = 20;
let resultado: integer = (edad_test * 2) + ((5 - 3) / 2);
