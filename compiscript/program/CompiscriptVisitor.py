...
class CompiscriptVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CompiscriptParser#initMethod.
    def visitInitMethod(self, ctx:CompiscriptParser.InitMethodContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by CompiscriptParser#SuperExpr.
    def visitSuperExpr(self, ctx:CompiscriptParser.SuperExprContext):
        return self.visitChildren(ctx)
